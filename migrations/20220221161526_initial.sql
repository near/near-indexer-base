...
-- CREATE INDEX account_changes_update_reason_idx ON account_changes (update_reason);
...
CREATE INDEX outputs_block_timestamp_idx ON action_receipts__outputs (block_timestamp);
...
CREATE INDEX execution_outcomes_block_timestamp_idx ON execution_outcomes (block_timestamp);
